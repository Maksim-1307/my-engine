...
void Sprite::laod_buffers(){
    ...
    glBufferData(GL_ARRAY_BUFFER, 12 * 3, vertices, GL_STATIC_DRAW);


    glGenBuffers(1, &color_VBO);
    glBindBuffer(GL_ARRAY_BUFFER, color_VBO);
    glBufferData(GL_ARRAY_BUFFER, 12 * 3, colors, GL_STATIC_DRAW);
    ...
    glBufferData(GL_ARRAY_BUFFER, 8 * 3, uv, GL_STATIC_DRAW);
